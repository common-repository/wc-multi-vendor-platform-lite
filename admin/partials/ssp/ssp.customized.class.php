...
class SSP {
    ...
    static function simple ( $request, $sql_details, $table, $primaryKey, $columns, $joinQuery = NULL, $extraWhere = '', $groupBy = '', $extra = '')

    {
        ...
        if($joinQuery){
            ...
            if($extra){
                ...
                $query =  "SELECT DISTINCT `".implode("`, `", SSP::pluck($columns, 'db'))."`
