...
(function( $ ) {
    ...
    wcmvp_split_url = wcmvp_url.split("#");
        ...
        $(document).ready(function( $ ){
		    if(wcmvp_split_url[1] == 'dashboard' || wcmvp_split_url[1] =="" ){
                ...
                $(document).find('.wcmvp_dashboard_content_wrappper').show();
                ...
                $(document).find(".wcmvp_main_card").show();
			...
			$(document).on('click','#wcmvp-admin-dashboard', function(){
